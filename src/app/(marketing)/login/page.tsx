    ...
    <AuthShell
      ...
      footer={
        <p className="text-center text-sm text-slate-600">
          Need an account?{' '}
          <Link href="/signup" className={authUi.secondaryLink}>
            Create one here
          </Link>
        </p>
      }
    >
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        >
          ...
          <p className="mt-4 text-xl font-semibold text-slate-900">Login as Student</p>
          <p className="mt-2 text-sm text-slate-600">Access modules, bookings, and live sessions.</p>
        </a>
        <a
          href={`/login/teacher${next ? `?next=${encodeURIComponent(next)}` : ''}`}
        ...
        >
          ...
          <p className="mt-4 text-xl font-semibold text-slate-900">Login as Teacher</p>
          <p className="mt-1 text-sm text-slate-600">Manage bookings, availability, and modules.</p>
        </a>
      </div>
    </AuthShell>
  )
